...
@Autonomous(name = "27NXTclose")
public class Nextgen27 extends PathChainAutoOpMode {
    ...
    private PathChain path1, path2, path3, path4, path5, path6, path7, path8, path9, opengate;
    ...
    protected void buildTaskList() {
        ...
        PathChainTask path4Task = new PathChainTask(path4, 1.5);
        tasks.add(path4Task);
