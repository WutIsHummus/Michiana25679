...
public class FConstants {
    static {
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.02 ,0.00,0.01,0.6,0);
        FollowerConstants.drivePIDFFeedForward = 0.05;
        ...
        FollowerConstants.pathEndVelocityConstraint = 5.0;
