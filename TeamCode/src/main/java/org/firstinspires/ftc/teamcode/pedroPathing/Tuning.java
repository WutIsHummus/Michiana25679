...
public class Tuning extends SelectableOpMode {
    ...
    public void onSelect() {
        ...
        // Always refresh all classes so their configurables appear in Panels

        PanelsConfigurables.INSTANCE.refreshClass(this);

        // Refresh all inner tuning classes so their configurables appear in Panels

        PanelsConfigurables.INSTANCE.refreshClass(ForwardTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(LateralTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(TurnTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(ForwardVelocityTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(LateralVelocityTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(ForwardZeroPowerAccelerationTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(LateralZeroPowerAccelerationTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(TranslationalTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(HeadingTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(DriveTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(Line.class);

        PanelsConfigurables.INSTANCE.refreshClass(CentripetalTuner.class);

        PanelsConfigurables.INSTANCE.refreshClass(Circle.class);
...
class LocalizationTest extends OpMode {
    ...
    public void init() {
        ...
        // Refresh this class's configurables when OpMode initializes

        PanelsConfigurables.INSTANCE.refreshClass(this.getClass());
    ...
    public void init_loop() {
        ...
        // Ensure configurables are refreshed in init_loop as well
