...
public class specmanual extends PathChainAutoOpMode {
    ...
    private boolean manual1Locked = false, manual2Locked = false;
    ...
    protected void buildPathChains() {
        ...
        thirdgrabdrive = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(pickup1Pose), new Point(thirdgrab)))
        ...
        intake1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(thirdgrab), new Point(intake)))
    ...
    protected void buildTaskList() {
        ...
        addPath(vision2deposit, 0)
                .addWaitAction(0, new SequentialAction(
                        ...
                        telemetryPacket -> { spitDone1 = true; return false; },
        ...
        addTurnToDegrees(-14, 0)
                .addWaitAction(0, new SequentialAction(
                        ...
                        motorActions.extendo.retracted(),
                        motorActions.extendo.waitUntilFinished(),
                        telemetryPacket -> { spitDone2 = true; return false; },
                        motorActions.extendo.findZero(),
                        motorActions.spin.poop(),
                        motorActions.spin.waitUntilEmpty(motorControl)
                ))
