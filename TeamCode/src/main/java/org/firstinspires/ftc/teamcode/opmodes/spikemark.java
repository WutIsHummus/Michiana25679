...
public class spikemark extends PathChainAutoOpMode {
    ...
    private final Pose intake1pose = new Pose(11, 25, Math.toRadians(0));
    ...
    protected void buildPathChains() {
        ...
        vision2deposit = follower.pathBuilder()
                ...
                .addParametricCallback(0.85, () -> run(motorActions.spin.poop()))
                .addParametricCallback(0.99,()-> run(motorActions.specimenExtend(0)))
        ...
        intake1 = follower.pathBuilder()
                ...
                .addParametricCallback(0.8, () -> motorControl.spin.setPower(-1))
                .addParametricCallback(0, () -> run(motorActions.spitSample()))
