...
@Autonomous(name = "FarRedShootCloser")
public class FarRedShootCloser extends PathChainAutoOpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(86.9955687, 9.14623338, Math.toRadians(90)));
    ...
    protected void buildPathChains() {
        ...
        path1 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(86.9955687, 9.14623338),
