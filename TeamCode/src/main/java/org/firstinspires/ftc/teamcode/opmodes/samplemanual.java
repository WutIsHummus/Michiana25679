        ...
        if (task == visionTurn1 || task == visionTurn2 || task == visionTurn3) {
            ...
            if (lastDistance != 0) {
                task.addWaitAction(0, motorActions.outtakeTransfer())
                        ...
                        .addWaitAction(()-> motorControl.getDetectedColor() == Enums.DetectedColor.YELLOW || motorControl.getDetectedColor() == Enums.DetectedColor.RED, motorActions.transferdepo2());
            }
