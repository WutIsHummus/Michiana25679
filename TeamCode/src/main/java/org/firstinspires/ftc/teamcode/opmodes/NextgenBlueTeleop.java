...
public class NextgenBlueTeleop extends OpMode {
    ...
    public static double f = 0.00085;
    ...
    public static double fLong = 0.00085;
    ...
    private static final double RPM_INTERCEPT = 1100;  // b in y = mx + b (was 1150)
    // b in y = mx + b

    // Far shooting RPM cap (for distances >= 7 feet)
    public static double FAR_SHOOTING_RPM_MAX = 1800;  // Reduced from 2100
    ...
    public void loop() {
        ...
        double shotTimeScale = isFarForShots ? 16.0 : 2.0;
        // NEW: for left-trigger behavior (single-shot vs auto-transfer)
        boolean isFarForTransfer = distanceFeetForTiming >= 0.0;  // ≥7ft = far
